...
object DummyContent {
    ...
    private fun addDozentenfoyer(): Mensa {
    ...
    private fun addMensaPolyterrasse(): Mensa {
        val menus: MutableList<Menu> = ArrayList()
        menus.add(
            Menu(
                "LOCAL",
    ...
    private fun addZentrum() {
        val mensas: MutableList<Mensa> = ArrayList()

        mensas.add(addDozentenfoyer())
        mensas.add(addMensaPolyterrasse())

        val location = Location("Zentrum", mensas);
